...
// In your main loop or an appropriate place, call applyRotation() when needed
...
int main(int argc, char **argv) {
  ...
  //         robotContext::gripper->readOnce();

  //         // Print the current width of the gripper
  //         std::cout << "Current gripper width: " << gripper_state.width << "
  //         m" << std::endl;
  ...
  robot.control([&time, &pose, &ik_controller, &phase,
    ...
    //   if (time >= 60.0 || (output_eigen_velocities.norm() < 0.0005 && dist <
    //   0.0005) ) {
